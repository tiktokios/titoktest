...
<form class="flex flex-1 items-center justify-center p-6">   
    ...
    <div class="relative w-full">
        ...
        <input
                    x-ref="input"
                    placeholder="Insert Douyin Video URL"
        ...
        <span class="px-1 flex items-center font-medium tracking-wide"> Download </span>
            ...
            {data() && (
                <div class='mt-2'>
                    ...
                    <div>
                        <video controls src={data()!.result.video1 ?? data()!.result.video_hd ?? data()!.result.video_watermark ?? data()!.result.video_diyoun ?? ""} class=" rounded-md shadow-md my-3 w-3/4 mx-auto"></video>
                    ...
                    <div class='flex flex-col justify-center gap-2 mt-2'>
                        ...
                        {data()!.result.video_hd && <a href={`https://dl.tiktokiocdn.workers.dev/api/download?url=${encodeURIComponent(data()!.result.video_hd ?? "")}&type=.mp4&title=${data()!.result.author?.nickname}`} class="p-2 bg-blue-600 shadow-md h-10 rounded text-white">Download Video HD Without Watermaker</a>}
                        {data()!.result.video_watermark && <a href={`https://dl.tiktokiocdn.workers.dev/api/download?url=${encodeURIComponent(data()!.result.video_watermark ?? "")}&type=.mp4&title=${data()!.result.author?.nickname}`} class="p-2 bg-blue-600 shadow-md h-10 rounded text-white">Download Video With Watermark</a>}
